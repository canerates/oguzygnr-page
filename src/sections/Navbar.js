...
import navbarData from "../contents/navbar.json"
...
const StyledAppBar = styled(AppBar)(({ theme, isScrolled }) => ({
  ...
  boxShadow: isScrolled
    ...
    : "none !important",
  padding: isScrolled ? "0.5rem 5rem 0.5rem 5rem" : "1rem 5rem 1rem 5rem",
          ...
          <Toolbar>
            <StyledLogoContainer>
              {isMain
                ...
                >
                  <PageLogo width={50} height={50} isSVG={false} isHovered={isLogoHovered} />
                </StyledScrollLinkLogo>
